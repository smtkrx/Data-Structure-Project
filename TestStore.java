...
public class TestStore {
  ...
  public static void main(String[] args) {
	  ...
	  String[]  book_names    = {"Moby Dick", "Les Miserables", "Kaşağı", "Utopia", "Hababam Sınıfı"} ;
	  ...
	  String[]  book_purchased    = {"Moby Dick", "Kaşağı", "Nutuk", "Utopia", "Hababam Sınıfı", "Moby Dick", "Nutuk", "Hababam Sınıfı", "Kaşağı", "Utopia"} ;
	  
	  String[]  delivery_books    = {"Utopia", "Les Miserables", "Nutuk", "Moby Dick", "Utopia", "Simyacı"} ;
